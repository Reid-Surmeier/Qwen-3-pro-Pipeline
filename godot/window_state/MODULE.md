...
`res://tests/run_party_window_state_contracts.gd` freezes the five-member source state, atomic mode and selection updates, honest unavailable icons, complete leave behavior, repeat/stale rejection, and byte-for-byte preservation on failure.
