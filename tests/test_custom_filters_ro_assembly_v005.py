...
if HAVE_PIL:
    from scripts import assemble_custom_filters_ro_v005 as assembly


@unittest.skipUnless(HAVE_PIL, "Pillow is not installed")
class CustomFiltersRoAssemblyV005Tests(unittest.TestCase):
    @classmethod
    ...
    def test_body_and_title_use_restrained_source_measured_edge_palettes(self) -> None:
        self.assertEqual(assembly.LABEL_INK, (46, 69, 96, 255))
        self.assertEqual(assembly.BODY_DEPTH_INK, (188, 197, 206, 255))
        self.assertEqual(
            assembly.LABEL_TEXT_EFFECTS,
            (
                ((1, 1), assembly.BODY_DEPTH_INK),
        ...
        self.assertEqual(assembly.TITLE_EDGE_INK, (250, 255, 255, 255))
        self.assertEqual(
            assembly.TITLE_TEXT_EFFECTS,
            (
                ((1, 1), assembly.TITLE_EDGE_INK),
        ...
        self.assertTrue(
            {assembly.LABEL_INK, assembly.BODY_DEPTH_INK}
            <= label_pixels
        )
        ...
        self.assertTrue(
            {assembly.TITLE_INK, assembly.TITLE_EDGE_INK}
            <= title_pixels
        )
    ...
    def test_v001_through_v004_are_retained_as_rejected_history(self) -> None:
        ...
        self.assertTrue(assembly.REJECTED_V004.exists())
