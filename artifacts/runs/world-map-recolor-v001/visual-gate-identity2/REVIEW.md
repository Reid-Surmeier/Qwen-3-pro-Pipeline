...
|---|---|---|---|
| A2 | registration: region land-centroid shift <=2px | PASS | `{"north-america": 0.0, "south-america": 0.0, "europe": 0.0, "africa": 0.0, "middle-east": 0.0, "asia": 0.0, "se-asia": 0.0, "australia": 0.0}` |
...
| A7 | palette census: candidate flat colours <= source's + 2 (final rule awaits pinned palette, #145) | PASS | `{"candidate": 9, "source": 9}` |
...
| A12 | leftover annotation ink (skipped: identity run) | PASS | `{"identity": true}` |
| A17 | border retention: >=97% of non-annotation black ink survives | PASS | `{"retention": 1.0, "lost_px": 0}` |
