...
`https://windows-wsl.taile06c45.ts.net/godot-v2-options/`
...
- **⊖ minimize** (x=1491 y=311): collapses the window to its title strip instantly;
...
```json
{
  "export_url": "https://windows-wsl.taile06c45.ts.net/godot-v2-options/",
